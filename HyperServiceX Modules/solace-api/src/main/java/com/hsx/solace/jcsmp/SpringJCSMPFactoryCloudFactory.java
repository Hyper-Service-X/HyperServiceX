 ...
 */
//Todo : Should be updated to handle list of properties ( Refer to SpringJCSMPFactory changes comparing to original library
...
public interface SpringJCSMPFactoryCloudFactory {
	 ...
	 */
	List<JCSMPProperties> getJCSMPProperties();
	 ...
	 */
	List<JCSMPProperties> getJCSMPProperties(SolaceServiceCredentials solaceServiceCredentials);
